...
export function generateLocaleDict(langString) {
  ...
  return mergeDeep({}, LANGS['pt-BR'], userLocale)
}

/**
 * 站点翻译
 * Se houver um parâmetro na URL (?locale=xx-XX ou ?lang=xx-XX), usa ele
 * Valida com regex (/[a-zA-Z]{2}(?:-[a-zA-Z]{2})?/ → ex.: en ou en-US).
 */
